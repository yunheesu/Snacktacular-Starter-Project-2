...
class SpotDetailViewController: UIViewController {
    ...
    var imagePicker = UIImagePickerController() // accessing image/photo
...
extension SpotDetailViewController: UINavigationControllerDelegate, UIImagePickerControllerDelegate { //accessing camera + image! write imagepicker.delegate on top
